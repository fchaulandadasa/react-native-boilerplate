...
const DrawerIcon = (props: DrawerIconButtonProps) => {
	const { darkMode: isDark } = useTheme();
	const barColor = isDark ? Colors.white : Colors.textGray800
	...
	const animatedTopBarStyles = useAnimatedStyle(() => {
		const backgroundColor = interpolateColor(progress.value, [0, 1], [barColor, barColor]);
